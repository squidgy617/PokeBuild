#############################################################################################
Custom Physics Engine (Actions, Subactions FastFall) V1.3b [Magus, Almas, DukeItOut, Squidgy]
# V1.3b - Adjusted so getting fighter ID is done in a safer way
#############################################################################################
HOOK @ $8085765C
{
  lwz r31, 0x8(r29)
  # Removed below for more accurate pointer, fixes non-variable expansion characters like Pokemon Trainer
  # lwz r31, 0x70(r29)
  # lwz r31, 0x20(r31)
  # lwz r31,0x0C(r31)
  # lwz r31,0x2D0(r31)
